...
from mcs_functions2 import reactFragDists, process_compF, getAtomFragments, get_common_atoms_frags, dict_to_sparse
    ...
    for r1 in rTarget:
        ...
        for r2 in rsp: 
            ...
            if S1 > 0 and S2 > 0:
                ...
                if RFavail ==0 or r2 not in rfDict.keys():
                    if arg.out:
